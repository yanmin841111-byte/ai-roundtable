...
const api: RendererApi = {
  ...
  revertTask: (scope?: 'task' | 'repair') => invoke('task:revert', scope),
  taskVerification: (messageId) => invoke('task:verification', messageId),
  reverifyTask: (messageId, confirmedCommand) => invoke('task:reverify', messageId, confirmedCommand),
